...
import { Eraser, FileText, Hash, House, Scissors, SquarePen, Image, Users, LogOut } from 'lucide-react'
...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    ...
    bottom-0 ${sidebar ? 'translate-x-0' :
        'max-sm:-translate-x-full'} transitiom-all duration-300
        ease-int-out`}>
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
            <div onClick={openUserProfile} className='flex gap-3 itmes-center cursor-pointer'>
